...
export const Contact: FC = () => {
  ...
  // FEATURE 2: Focus tracking state
              ...
              >
                ...
                <motion.div variants={itemVariants} className="space-y-2">
                  <div className="flex justify-between items-baseline">
                    ...
                    {/* FEATURE 2: Contextual Eye-Candy Message */}
                    <AnimatePresence>
                      {activeField === "name" && (
                        <motion.span 
                          ...
                          className="text-[10px] tracking-wide text-[#c49a6c]/80 font-light"
                        >
                          We prefer your real name
                        </motion.span>
                      )}
                    </AnimatePresence>
                  </div>
                ...
                <motion.div variants={itemVariants} className="space-y-2 relative">
                  <div className="flex justify-between items-baseline">
                    ...
                    {/* FEATURE 2 & 3 Dynamic toggle text overlay based on text length or focus state */}
                ...
                >
                  <Button 
                    ...
                    type="submit" 
                    disabled={isBrewing}
                    className="w-full justify-center gap-2 bg-cream text-coffee-dark hover:bg-white rounded-sm py-4 text-xs uppercase tracking-widest font-semibold transition-colors duration-300 cursor-pointer disabled:cursor-not-allowed disabled:opacity-80 active:scale-[0.99]"
                  >
                    {isBrewing ? (
                      <>
